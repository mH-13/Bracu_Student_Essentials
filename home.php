<html lang="en">
    ...
    <body> 
        ...
        <section id = "section1">
            <div class="title" style= "margin-left:5%; margin-right:20%; margin-top:300px; margin-bottom:300px;
            text-align:center; color: #706F8E"> All you need as a student is here! </div>
