        ...
        <section id="header">
            <div class="row">  
                ...
                <div class="col-md-10" style="text-align: right; margin-left: 250px;"> 
                    <a href="home.php?user_id=<?php echo urlencode($user_id);?>"> Home </a> 
                    <a href="show_students.php?user_id=<?php echo urlencode($user_id);?> " style="margin-left: 20px;"> Students </a> 
